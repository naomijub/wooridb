...
- [x] Match Update: Updates only if precondition is matched. Example request `curl -X POST -H "Content-Type: application/wql" <ip>:1438/wql/query -d 'MATCH ALL(a > 100, b <= 20.0) UPDATE test_match_all SET {{a: 43, c: Nil,}} INTO 48c7640e-9287-468a-a07c-2fb00da5eaed from my_entity_name'`. Possible preconditions:
